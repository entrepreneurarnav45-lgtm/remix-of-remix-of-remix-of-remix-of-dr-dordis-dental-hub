...
const nav = [["Home", "home"], ["About Dr. Dordi", "doctor"], ["Treatments", "treatments"], ["Before & After", "results"], ["Clinic", "clinic"], ["Contact", "contact"]] as const;
